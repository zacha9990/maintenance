        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="post" id="dp-form-create">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        <label for="phone_number" class="form-label">Ho HP / (WhatApp)</label>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Lengkapi Surat Pengantar Desa untuk melakukan
                                                pengarsipan. jika
                                                sudah
                                                pernah mengunggah Surat Pengantar Desa, anda dapat mengunduhnya
                                                kembali.
                                                Apabila
                                                ada
                                                kesalahan, silahkan mengunggah file yang benar.</p>
                                            <div class="text-center">
                                                <input type="file" name="village_chief_letter"
                                                    ...
                                                    accept="image/png,image/jpg,image/jpeg,image/webp,application/pdf" />
                                                <div id="village_chief_letter_gallery" class="col-md-10 mt-4">
                                                </div>
...
@section('scripts')
    <script>
        ...
        var dpStore = '{{ route('developmentProposal.store') }}';
