        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('assetHandover.update', $assetHandover->id) }}" method="post"
                            id="ah-form-edit">
                            @csrf
                            {{ method_field('PUT') }}
                            <div class="row">
                                        ...
                                        <select name="developer_id" id="developer_id" class="form-control">
                                            @foreach ($developers as $developer)
                                                <option value="{{ $developer->id }}"
                                                    {{ $developer->id == $assetHandover->developer_id ? 'selected' : '' }}>
                                                    {{ $developer->user->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="housing_capacity"
                                            name="housing_capacity" value="{{ $assetHandover->housing_capacity }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="year_build" name="year_build"
                                            value="{{ $assetHandover->year_build }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="address" class="form-control" id="address" cols="10" rows="10">{{ $assetHandover->address }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <select name="psu" id="psu" class="form-select"
                                            ...
                                            <option value="Sarana" {{ $assetHandover->psu == "Sarana" ? "selected" : "" }}>Sarana</option>
                                            <option value="Prasarana" {{ $assetHandover->psu == "Prasarana" ? "selected" : "" }}>Prasarana</option>
                                            <option value="Utilitas" {{ $assetHandover->psu == "Utilitas" ? "selected" : "" }}>Utilitas</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="psu_details" name="psu_details"
                                            value="{{ $assetHandover->psu_details }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="any" name="longitude" class="form-control"
                                            id="longitude" value="{{ $assetHandover->longitude }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="any" name="latitude" class="form-control"
                                            id="latitude" value="{{ $assetHandover->latitude }}">
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="text-center">
                                                <input type="file" name="documents[]" id="documents"
                                                    ...
                                                    accept="image/png,image/jpg,image/jpeg,image/webp,application/pdf"
                                                    multiple />
                                                <div id="documents_gallery" class="col-md-10 mt-4">
                                                    @foreach ($assetHandover->documents as $file)
...
@section('scripts')
    ...
    <script>
        var ahStore = "{{ route('assetHandover.update', $assetHandover->id) }}";
