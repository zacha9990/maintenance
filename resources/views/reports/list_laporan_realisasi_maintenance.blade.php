    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                Daftar maintenance yang sudah selesai.
            </div>
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-sm-6">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th><a href="{{ route('reports.reportForm', ['sort' => 'name', 'param' => 'laporan_realisasi_maintenance']) }}">Nama Alat</a></th>
                            <th>Pabrik</th>
                            <th><a href="{{ route('reports.reportForm', ['sort' => 'completed_date', 'param' => 'laporan_realisasi_maintenance']) }}">Tanggal
                                    Selesai</a></th>
                            <th>Keterangan</th>
                            <th>Aksi</th>
                        </tr>
                    ...
                    <tbody>
                        @foreach ($lists as $maintenance)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('reports.laporanRealisasiMaintenance', $maintenance->id) }}"
                                        class="btn btn-primary btn-sm">
                                        <i class="fas fa-print"></i>     Cetak LaporanRealisasi</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
...
<script>
    ...
    document.getElementById('filter_factory').addEventListener('change', function () {
      ...
      var url = "{{ route('reports.reportForm', ['param' => 'laporan_realisasi_maintenance']) }}";
