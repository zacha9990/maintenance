            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        Edit Data Pengembang
                    </div>
                    <div class="card-body">
                        <form action="{{ route('developer.update', $developer->id) }}" method="post" id="dev_form">
                            @csrf
                            {{ method_field('PUT') }}
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="penanggung_jawab"
                                            name="penanggung_jawab" value="{{ $developer->penanggung_jawab }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        <label for="date_year" class="form-label">Tahun</label>
                                        <input type="text" class="form-control" id="date_year" name="date_year"
                                            value="{{ $developer->date_year }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="any" name="longitude" class="form-control"
                                            id="longitude" value="{{ $developer->longitude }}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <textarea name="address" class="form-control" id="address" cols="30" rows="10">{{ $developer->address }}</textarea>
                                </div>
                            </div>
...
@section('scripts')
    ...
    <script>
        var devStore = "{{ route('developer.update', $developer->id) }}";
